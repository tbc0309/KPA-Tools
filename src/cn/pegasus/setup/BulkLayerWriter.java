...
final class BulkLayerWriter {
 ...
 static void write(File run,Map<String,SetupEngine.Item> items,int offset,int total)throws Exception {
  ...
  Map<String,List<SetupEngine.Item>> groups=new LinkedHashMap<>();Map<String,Set<String>> privateFiles=new LinkedHashMap<>(),privateDirs=new LinkedHashMap<>();Set<String> parents=new LinkedHashSet<>(),labels=new LinkedHashSet<>();
